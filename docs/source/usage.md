...
You can install ij-open-data via [uv](https://docs.astral.sh/uv/):

```shell script
uv install ij_open_data
```

### With pip

You can install ij-open-data via [pip](https://pip.pypa.io/):

```shell script
pip install ij_open_data
```
